...
## 9. Chris Dunn — added 2026-08-22

First-party biography says 25+ years in markets, full-time stock/e-mini futures trading from 2007, Bitcoin since 2013, and Wealth Incubator founded in 2013. These career details are self-reported in the reviewed source set.

A 2015 public recap claims 15 target hits, 2 failures and 2 breakevens among 19 posted predictions/alerts. It is not independently audited. The same recap includes losing trades and missed fills.

### 1234 Crypto Breakout
1. directional run;
2. lower-volume pullback;
3. consolidation/retest of horizontal resistance;
4. high-volume resistance breakout.

He prefers swing trading, fewer trades, larger moves, preplanned stop/size/targets, and scaling out at targets. Historical ETH parameters are examples, not universal rules.

**Fidelity:** `SOURCE_FAITHFUL_WITH_DISCRETION`.

## 10. Josh Olszewicz / CarpeNoctom — added 2026-08-22

A direct 2020 Set Protocol interview says he entered Bitcoin in 2013, was trading at Techemy, held a Master's in Biotechnology and favored objective trend-following systems. Current professional title is unconfirmed.

Public footprint includes CarpeNoctom YouTube, historical TradingView `IAmSatoshi`, and historical TokenSets GATOR.

His public crypto Ichimoku guide explicitly uses `20/60/120/30` and covers fractal trailing stops, trend reversals and cloud edge-to-edge trades.

The Alligator + Fractal strategy uses three Alligator moving averages for trend and fractals for entries/stops, but the exact GATOR parameterization was not recovered. Exact replication remains blocked.

**Fidelity:** Ichimoku components `SOURCE_FAITHFUL_WITH_DISCRETION`; GATOR exact strategy `FORMALIZED_FROM_PUBLIC_CORE`.
