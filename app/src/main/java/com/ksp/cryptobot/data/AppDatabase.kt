            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    """CREATE TABLE IF NOT EXISTS research_events(
                        ...
                        score REAL NOT NULL,
                        sampleCount INTEGER NOT NULL,
                        trainWindow TEXT NOT NULL,
                        testWindow TEXT NOT NULL,
                ...
                db.execSQL("CREATE INDEX IF NOT EXISTS index_research_events_eventType_timestampEpochMs ON research_events(eventType,timestampEpochMs)")
                db.execSQL("CREATE INDEX IF NOT EXISTS index_research_events_symbol_timestampEpochMs ON research_events(symbol,timestampEpochMs)")
                db.execSQL("CREATE INDEX IF NOT EXISTS index_research_events_strategy_regime_timestampEpochMs ON research_events(strategy,regime,timestampEpochMs)")
                db.execSQL(
                    """CREATE TABLE IF NOT EXISTS research_strategy_profiles(
                        strategyKey TEXT NOT NULL PRIMARY KEY,
                        updatedAtEpochMs INTEGER NOT NULL,
                        sampleSize INTEGER NOT NULL,
                        wins INTEGER NOT NULL,
                        losses INTEGER NOT NULL,
                        totalPnlEur REAL NOT NULL,
                        winRatePercent REAL NOT NULL,
                        profitFactor REAL NOT NULL,
                        walkForwardScore REAL NOT NULL,
                        monteCarloScore REAL NOT NULL,
